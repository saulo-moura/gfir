...
echo "<div class=''>";
echo " CHAMAR PRÓXIMO CLIENTE PARA ATENDIMENTO";
echo "</div>";
...
if ($senha_totem == "") {
    ...
    echo " <div style='margin:15px; '>Cliente sem SENHA Não pode ser CHAMADO PARA ATENDIMENTO.</div>";
    echo " </div>";
} else {
    if ($status_painel == '99') {
        echo " <div class='botao_ag'  >";
        ...
        if ($status_painel == '20') {
            ...
            echo "<div id='mostra_mensagem_cancelada' title='' style=' width:100%; display:none; float:left; text-align:center; font-size:{$fsize};  '>";
        ...
        if ($status_painel != '20' and $status_painel != '80' and $status_painel != '99') {
            if ($_SESSION[CS]['g_atendimento_relacao'] == '') {
                echo " <div id='chama_clid' class='botao_ag'  >";
                echo " <div id='chama_cli' style='margin:15px; '>Não pode fazer um atendimento, pois o usuário não tem relacionamento com o PA!</div>";
                echo " </div>";
            } else {
            ...
            /*
              echo " <div id='termina_atd' style='display:none; '  class='botao_ag' onclick='return TerminarAtendimento({$idt_atendimento_agenda});' >";
              echo " <div style='margin:15px; '>Terminar o Atendimento </div>";
              echo " </div>";
             */
        }
