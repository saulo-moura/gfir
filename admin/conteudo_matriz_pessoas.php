...
if ($_REQUEST['idt_calendario'] == '')
    $idt_calendario ='';
else
	$idt_calendario = $_REQUEST['idt_calendario'];
 ...
 <div id="div_topo">
            <center>
                <div class="meio ctopo">
                    <a href="#"  onclick='javascript:top.close();' title='Retorna a tela principal do site' class="intranet">Home</a>
...
<table border="0" cellpadding="0" width="100%" cellspacing="0" class="Menu_printqsma">
    <tr>
        <?php
            ...
            //$path = 'imagens/';
            //$img_empreendimento = 'logo_conexxion.jpg';
            //$nm_empreendimento  = 'CONEXXION';
            echo "<div onclick='javascript:top.close();' title='Retorna a Home ' style='cursor:pointer; padding-left:15px;'>";
//            ImagemMostrar(200, 54, $path, $img_empreendimento, $nm_empreendimento, false);
            ...
            //echo '<img style="padding:5px;" src="imagens/sgc_cab_identidade_corporativa.png" xwidth="305" xheight="115" alt="Comunicação com o Administrador do Sistema" border="0" />';
            //echo '</td>';
            echo '<td align="left" style="font-size: 24px; padding:5px;">';

                        echo "<div  style='xborder: 1px solid red; '>";
            echo "<center>";
            $titulo_modulo="LISTA DE COLABORADORES";
            echo "<div  id='titulo_modulo' style=''>";
            echo  $titulo_modulo;
            echo '</div>';
          //  echo '<img style="padding:5px;" src="imagens/sgc_cab_desc_identidade_corporativa.png" xwidth="305" xheight="115" alt="Comunicação com o Administrador do Sistema" border="0" />';
            echo '</div>';
            echo '</td>';
  ...
  //          echo '<img style="padding:5px;" src="imagens/logo_pentagon2.jpg" width="82" height="53"  border="0" />';
            echo '</div>';
            echo '</td>';
 ...
 <div id="barra_topo_m">
                             ...
                             //           echo '       <a href="javascript:top.close();" title="Clique aqui retornar">Retornar</a>';
                             
                                        echo '       <a href="javascript:parent.hidePopWin(true);" title="Clique aqui retornar"><img alt="" src="imagens/sair.png" width="32" height="32"></a>';

                                        echo ' </div>  ';


//echo '   <div class="bt_topo_barra" style="xheight:40px; width:80px;"> ';
//echo '       <a href="javascript:parent.hidePopWin(true);" title="Clique aqui retornar">Retornar</a>';
//echo '   </div>  ';
...
<div class="Meio" id="Meio">
    ...
    if ($prefixo=='listar' or $prefixo=='cadastro')
    {
        $acao=$_REQUEST['acao'];
    ...
    else
    {
        ...
        $prefixo      = "inc";
        $menu         = "matriz_lista_pessoas";
        $Require_Once = "$prefixo$menu.php";
    }
    
   // echo " vvvvvvvvvvvvvvvv ".$Require_Once;
    
    if (file_exists($Require_Once)) {
    	Require_Once($Require_Once);
    } else {
      //  echo "<script type='text/javascript'>self.location = 'conteudo_posicao_peca.php?prefixo=listar&menu=dados_contrato';</script>";
        exit();
    }
    ?>
</div>
