...
<input type="hidden" id="dtBancoObj" value="<?php echo date("d/m/Y"); ?>" />
 <div id="barra_topo_m">
										...
										echo '       <a href="javascript:RetornarClose();" title="Clique aqui retornar"><img alt="" src="imagens/sair.png" width="32" height="32"></a>';
			...
			//<a href="javascript:parent.hidePopWin(true);" title="Clique aqui retornar">Retornar</a>';
                                        ...
                                        ?>
                                        <div id="resto_m"><?php echo 'Salvador, '.date("d").' de '.$vetMes[date("n")].' de '.date("Y"); ?>
                                        </div>
...
<div class="Meio showPopWin_width" id="Meio">
    <?php
   $acao ='alt';
   
// class="showPopWin_width"   
   
   $id   = $_GET['idt_atendimento_agenda'];
...
var retorno_close_w=0;

function RetornarClose()
{
   //alert('ajustar'); 
   // top.close();
   retorno_close_w=1;
