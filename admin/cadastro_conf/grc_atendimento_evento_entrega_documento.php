...
$tabela = 'grc_atendimento_evento_entrega_documento';
$id = 'idt';

$vetCampo['idt_atendimento_evento_entrega'] = objFixoBanco('idt_atendimento_evento_entrega', 'Entrega do Produto', 'grc_atendimento_evento_entrega', 'idt', 'descricao', 0);
...
$vetFrm[] = Frame('<span>Documento do Tipo de Serviço</span>', Array(
    Array($vetCampo['idt_atendimento_evento_entrega']),
