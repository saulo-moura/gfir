...
$sql = "select  ";
$sql .= "   grc_a.*,  ";
$sql .= "   year(grc_at.data) as grc_at_ano,  ";
...
echo $header;
echo "</td>";
echo "<td xcolspan='3' style='{$stylo} width:80%;' >";
...
echo "<tr>";
echo "<td  xcolspan='3' style='{$stylo} xwidth:50%; ' >";
echo "Data do Diagnóstico: <b>{$data_avaliacao}</b>";
echo "</td>";
echo "<td  xcolspan='2' style='{$stylo} xwidth:50%;' >";
echo "Cliente: <b>{$gec_eclip_descricao}</b>";
echo "</td>";
echo "</tr>";

echo "<tr>";
echo "<td  xcolspan='3' style='{$stylo}' >";
echo "Agente de Orientação Empresarial: <b>{$gec_ecrep_descricao}</b>";
echo "</td>";
echo "<td  xcolspan='2' style='{$stylo}' >";
...
$stylo = "padding:5px; font-family : Calibri, Arial, Helvetica, sans-serif; text-align:center; font-size:10pt; color:$color; background:$background;";
echo "<br /><br />";
echo "<table border='0' cellspacing='0' cellpadding='0' width='100%' style='' >";
echo "<tr>";
echo "<td  xcolspan='5' style='{$stylo} text-align:left;' >";
...
echo "<table border='0' cellspacing='0' cellpadding='0' width='100%' style='' >";
echo "<tr>";
echo "<td  xcolspan='5' style='{$stylo} text-align:center; ' >";


echo "<div style='text-align:center; display:block;'>";
echo "_________________________________, de _________________________ de $grc_at_ano <br /><br /><br />";
