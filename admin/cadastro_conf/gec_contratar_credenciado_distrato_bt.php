    ...
    if ($acao == 'exc') {
        ...
        if ($rowDados['situacao'] == 'RE' || $rowDados['situacao'] == 'GP' || $rowDados['situacao'] == 'CG' || $rowDados['situacao'] == 'DI') {
            ...
            if ($rs->rows > 0) {
                ...
                echo "<div class='botao_ag_bl' onclick='btCancelar();'>Reprovar Distrato</div>";
            } else {
...
if ($_SESSION[CS]['g_abrir_sistema_origem'] != 'PFO') {
    ...
    if ($rs->data[0][0] != '') {
        echo "<div class='botao_ag_bl' onclick='AbrirEvento(" . $rs->data[0][0] . ");'>Consultoria Retificadora</div>";
    }
}
...
<script type="text/javascript">
    ...
    function btAssinar() {
        onSubmitMsgTxt = 'Confirma a Assinatura do Distrato?';
        $('#situacao').val('AS');
        $(':submit:first').click();
    }
