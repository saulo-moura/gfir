...
$Entidade     = "Evento de Política de Vendas";
$Entidade_p   = "Eventos de Política de Vendas";
...
$sql = "select idt, codigo, descricao from grc_evento ";
$vetCampo['idt_evento'] = objCmbBanco('idt_evento', 'Evento', true, $sql,'','width:500px;');
//
//$maxlength  = 4000;
//$style      = "width:700px;";
//$js         = "";
