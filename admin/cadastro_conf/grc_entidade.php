...
$vetFrm[] = Frame('<span>3 - COMUNICAÇÃO (ENDEREÇOS, TELEFONES, EMAIL...) </span>', '', $class_frame_p, $class_titulo_p, $titulo_na_linha_p, $vetParametros);
...
if ($veio == "O")
{   // Documentos e área de conhecimento
    ...
    $vetCampo['observacao']       = CriaVetTabela('Observação');
    $titulo = 'Documentos da Organização ';
...
/*
    ...
    $vetFrm[] = Frame('<span>7 - ÁREA DE CONHECIMENTO</span>', '', $class_frame_p, $class_titulo_p, $titulo_na_linha_p, $vetParametros);
    ...
    $Entidade_p       = "Áreas de Conhecimento da Entidade";
    $CampoPricPai     = "idt_entidade";
...
else
{
    ...
    $vetFrm[] = Frame('<span>6 - ÁREA DE CONHECIMENTO</span>', '', $class_frame_p, $class_titulo_p, $titulo_na_linha_p, $vetParametros);
