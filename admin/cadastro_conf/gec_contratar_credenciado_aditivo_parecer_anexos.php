...
$TabelaPai = "gec_contratar_credenciado_aditivo_parecer";
$AliasPai = "gec_ccd";
$EntidadePai = "";
$idPai = "idt";
//
$TabelaPrinc = "gec_contratar_credenciado_aditivo_parecer_anexos";
$AliasPric = "gec_ccaa";
$Entidade = "Arquivo em Anexo";
$Entidade_p = "Arquivos em Anexo";
$CampoPricPai = "idt_gec_contratar_credenciado_aditivo_parecer";
