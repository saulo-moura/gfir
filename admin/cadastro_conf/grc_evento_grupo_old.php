...
$vetCampo['idt_cidade'] = objCmbBanco('idt_cidade', 'Cidade', true, $sql, ' ', 'width:230px;', '', true, $_GET['idt_cidade']);
...
$vetCampo['idt_local'] = objCmbBanco('idt_local', 'Local/Sala', true, $sql, ' ', 'width:270px;', '', true, $_GET['idt_local'], true);
...
if ($idt_instrumento != 2) {
    ...
    MesclarCol($vetCampo['idt_cidade'], 3);
    MesclarCol($vetCampo['idt_local'], 3);
    //
