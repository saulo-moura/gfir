...
$AliasPai = "grc_ae";
$EntidadePai = "Especialidade do Serviço";
$idPai = "idt";
//
...
if ($_GET['id'] == 0 || $_GET['id'] == -1 || $_POST['idorg'] == -1) {
    ...
    $vetCampo['idt_produto'] = objListarCmbMulti('idt_produto', 'grc_produto_cmb', 'Produto do Serviço', true, '', '', '', $vetRetorno);
} else {
    $vetCampo['idt_produto'] = objListarCmb('idt_produto', 'grc_produto_cmb', 'Produto do Serviço', true);
}
...
$titulo_cadastro = 'PRODUTO DO SERVIÇO';
