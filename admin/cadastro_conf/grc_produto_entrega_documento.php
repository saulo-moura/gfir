...
$tabela = 'grc_produto_entrega_documento';
$id = 'idt';

$vetCampo['idt_produto_entrega'] = objFixoBanco('idt_produto_entrega', 'Entrega do Produto', 'grc_produto_entrega', 'idt', 'descricao', 0);
...
$vetFrm[] = Frame('<span>Documento do Tipo de Serviço</span>', Array(
    Array($vetCampo['idt_produto_entrega']),
