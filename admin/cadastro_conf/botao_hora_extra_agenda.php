<?php
echo " <div onclick='return ConfirmaHoraExtra({$idt_atendimento_agenda});' style='color:#004080; font-size:14px; cursor:pointer; float:left; padding-top:20px; padding-bottom:20px; padding-left:0px; padding-right:5px;'>";
...
function ConfirmaHoraExtra(idt_atendimento_agenda)
{
