...
#idt_helpdesk_interacao_obj {
   xwidth:100%;
   
}

#idt_helpdesk_interacao_tf {
   font-size:16px;
   font-weight:normal;
   padding:3px;
   background:#FFFFCA;
...
$TabelaPai   = "plu_helpdesk_interacao";
$AliasPai    = "plu_hdi";
$EntidadePai = "Anexos da Interação do";
$idPai       = "idt";
...
$CampoPricPai     = "idt_helpdesk_interacao";

$tabela = $TabelaPrinc;


$idt_helpdesk_interacao_anexo = $_GET['id'];
...
if ($acao!='inc')
{
     ...
     $sql .= " where idt = {$idt_helpdesk_interacao_anexo} ";
     $rs = execsql($sql);
