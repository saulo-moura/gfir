...
$vetCampo['idt_acao'] = objListarCmb('idt_acao', 'grc_projeto_acao', 'Ação', false, '442px');
...
$vetCampo['dt_validade_inicio'] = objData('dt_validade_inicio', 'Válido de', False);
...
$vetCampo['matricula_intranet'] = objTexto('matricula_intranet', 'Matrícula (para Funcionários)', false, 15, 20);
...
$vetCampo['alt_status_produto'] = objCmbVetor('alt_status_produto', 'Alterar a Situação do Produto', True, $vetSimNao);
$vetCampo['evento_sincroniza_rm'] = objCmbVetor('evento_sincroniza_rm', 'Poder colocar o Evento SGTEC para Evento para meta física', True, $vetSimNao);
$vetCampo['evento_muda_dt_real_ini_hist'] = objCmbVetor('evento_muda_dt_real_ini_hist', 'Poder mudar a Data de Realização de Início do Evento', True, $vetSimNao);

$vetCampo['cpf'] = objCPF('cpf', 'CPF', false);
$vetCampo['codparceiro_siacweb'] = objHidden('codparceiro_siacweb', '', 'Código SiacWeb', true);

$vetCampo['evento_canal_registro'] = objTexto('evento_canal_registro', 'Descrição do Canal do Registro para Inscrição no Evento', false, 45);
