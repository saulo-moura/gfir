...
$bt_alterar_lbl = 'Registrar Ausência';
$bt_voltar_lbl  = 'Retorna sem registrar';
$onSubmitDep    = 'grc_atendimento_agenda_ausencia_dep()';
...
if ($acao!='inc')
{
	 ...
	 {
		 if ($semmarcacao!='S' or $idt_marcador  == $_SESSION[CS]['g_id_usuario'])
		 {
			...
			execsql($sql);
			$vetPar=Array();
			$vetPar['tipo']                  ='INICIANDO AUSÊNCIA';
...
$js="  ";
$vetCampo['telefone']         = objTelefone('telefone', 'Telefone de Contato', true, $js);
$vetCampo['celular']          = objTelefone('celular', 'Celular de Contato', true, $js);
$vetCampo['email']            = objEmail('email', 'Email de Contato', true, 35, 120,'S');
