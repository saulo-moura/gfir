...
//$vetCampo['CodAtivEcon']        = objTexto('CodAtivEcon', 'Atividade Econômica', false, 5, 5);
...
$vetCampo['CodAtivEcon'] = objCmbBanco('CodAtivEcon', 'Atividade Econômica', true, $sql,' ','width:400px;');
