...
// echo " <div  style='width:100%; color:#000000; float:left; border-top:1px solid #ABBBBF; border-bottom:1px solid #ABBBBF; '>";
    ...
    $onclick =  " onclick='return ConfirmaHistorico_organizacao({$idt_atendimento_tmp}, \"$cnpj\");' ";
...
<script>
    ...
    function ConfirmaHistorico_organizacao(idt_atendimento,cnpj)
    {
