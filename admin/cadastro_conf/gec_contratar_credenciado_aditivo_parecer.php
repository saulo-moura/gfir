...
$idPai = "idt";
//
$TabelaPrinc = "gec_contratar_credenciado_aditivo_parecer";
$AliasPric = "gec_ccaa";
...
$vetCampoLC['arquivo'] = CriaVetTabela('Arquivo', 'func_trata_dado', fnc_gec_contratar_credenciado_aditivo_parecer_anexos);
...
$sql .= ' from ' . db_pir_gec . 'gec_contratar_credenciado_aditivo_parecer_anexos gec_ccda ';
$sql .= ' inner join ' . db_pir_gec . 'plu_usuario plu_usu on plu_usu.id_usuario = gec_ccda.idt_responsavel ';
$sql .= ' where idt_gec_contratar_credenciado_aditivo_parecer = $vlID';
$sql .= ' order by data_registro';

$vetCampo['gec_contratar_credenciado_aditivo_parecer_anexos'] = objListarConf('gec_contratar_credenciado_aditivo_parecer_anexos', 'idt', $vetCampoLC, $sql, $titulo, false);

$vetFrm[] = Frame('<span>' . $titulo . '</span>', Array(
    Array($vetCampo['gec_contratar_credenciado_aditivo_parecer_anexos']),
