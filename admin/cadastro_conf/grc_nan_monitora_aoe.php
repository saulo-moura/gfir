...
$sql .= " where grc_ne.idt_acao = ".null($rsa->data[0][0]);
...
$vetVariavel=Array(); 
$vetCampo['grc_nan_monitora_aoe_include'] = objInclude('grc_nan_monitora_aoe_include', 'cadastro_conf/grc_nan_monitora_aoe_include.php', $vetVariavel);
...
MesclarCol($vetCampo['idt_tutor'], 3);
...
$vetFrm[] = Frame('', Array(
    Array($vetCampo[$CampoPricPai]),
    Array($vetCampo['grc_nan_monitora_aoe_include']),
        ), $class_frame, $class_titulo, $titulo_na_linha);
$vetCad[] = $vetFrm;
