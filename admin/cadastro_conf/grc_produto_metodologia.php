...
$sql  = "select idt, codigo, descricao from grc_produto_metodologia_n ";
$sql .= " order by codigo";
$vetCampo['idt_produto_metodologia'] = objCmbBanco('idt_produto_metodologia', 'Metodologia Associada', true, $sql,' ','width:180px;');
...
$vetFrm[] = Frame('<span>Metodologia Associada</span>', Array(
    Array($vetCampo['idt_produto_metodologia']),
),$class_frame,$class_titulo,$titulo_na_linha);
