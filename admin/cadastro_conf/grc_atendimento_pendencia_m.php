...
if ($pendencia_sistema == 'GRC') {
    ...
    switch ($row['tipo']) {
        case 'Evento Combo':
            $url = 'conteudo.php?acao=alt&prefixo=cadastro&voltar=pendencia_listar&menu=grc_evento_combo_cad&id=' . $row['idt_evento_combo_origem'] . '&idt_pendencia=' . $row['idt'];
            echo '<script type="text/javascript">self.location = "' . $url . '";</script>';
            exit();
            break;

        case 'Publicação de Eventos':
            $url = 'conteudo.php?acao=alt&prefixo=cadastro&voltar=pendencia_listar&menu=grc_evento_publicar&id=' . $row['idt_evento_publicar'] . '&idt_pendencia=' . $row['idt'];
            echo '<script type="text/javascript">self.location = "' . $url . '";</script>';
            exit();
            break;
        ...
        case 'Aprovação do Distrato':
            ...
            $sql .= ' where ccd.idt = ' . null($row['idt_contratar_credenciado_distrato']);
            $rs = execsql($sql);

            $url = 'conteudo.php?acao=alt&prefixo=cadastro&voltar=pendencia_home&menu=gec_contratar_credenciado_distrato&id=' . $rs->data[0][0] . '&idt_pendencia=' . $row['idt'];
            echo '<script type="text/javascript">self.location = "' . $url . '";</script>';
            exit();
            break;
        ...
        case 'Aprovação do Aditamento':
            ...
            $sql .= ' where ccd.idt = ' . null($row['idt_contratar_credenciado_aditivo']);
            $rs = execsql($sql);

            $url = 'conteudo.php?acao=alt&prefixo=cadastro&voltar=pendencia_home&menu=gec_contratar_credenciado_aditivo&id=' . $rs->data[0][0] . '&idt_pendencia=' . $row['idt'];
            echo '<script type="text/javascript">self.location = "' . $url . '";</script>';
            exit();
            break;
        ...
        case 'Atendimento Distância':
            ...
            $url = 'conteudo.php?prefixo=inc&menu=grc_atender_cliente&session_volta=avulso&idt_atendimento_agenda=' . $idt_atendimento_agenda . '&idt_atendimento=' . $row['idt_atendimento'] . '&id=' . $idt_atendimento_agenda . "&pesquisa=" . $pesquisa . '&aba=2&idt_atendimento_pendencia=' . $row['idt'];
            echo '<script type="text/javascript">self.location = "' . $url . '";</script>';
            exit();
            break;

        case 'Atendimento Webservice':
            $sql = '';
            $sql .= ' select idt_atendimento_agenda';
            $sql .= ' from grc_atendimento';
            $sql .= ' where idt = ' . null($row['idt_atendimento']);
            ...
            $url = 'conteudo.php?prefixo=inc&menu=grc_atender_cliente&menu_origem=grc_atendimento&session_volta=avulso&idt_atendimento_agenda=' . $idt_atendimento_agenda . '&idt_atendimento=' . $row['idt_atendimento'] . '&id=' . $idt_atendimento_agenda . '&aba=1&pesquisa=' . $pesquisa;
            echo '<script type="text/javascript">self.location = "' . $url . '";</script>';
            exit();
            break;
...
//
    ...
    if ($idt_evento > 0) {
        $url = 'conteudo.php?acao=alt&prefixo=cadastro&voltar=pendencia_listar&menu=grc_evento&id=' . $idt_evento . '&idt_pendencia=' . $idt_atendimento_pendencia;
        echo '<script type="text/javascript">self.location = "' . $url . '";</script>';
        exit();
    }
...
//    $js_hm   = " disabled  ";
    ...
    $vetCampo['data_solucao'] = objDataHora('data_solucao', 'Prazo de Resposta', False, $js, '', '');
