...
$vetCampo['cc_rm'] = objInclude('cc_rm', 'cadastro_conf/grc_evento_participante_contadevolucao_rm.php');
...
$vetCampo['bt_novo'] = objInclude('bt_novo', 'cadastro_conf/grc_evento_participante_contadevolucao_bt.php');
...
<script type="text/javascript">
    function grc_evento_participante_contadevolucao_dep() {
