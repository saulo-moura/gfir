...
$bt_alterar_lbl = 'Excluir Agendamento';
$bt_voltar_lbl  = 'Retorna sem Excluir';
$onSubmitDep    = 'grc_atendimento_agenda_excluir_dep()';
...
function grc_atendimento_agenda_excluir_dep() {
        var ok = true;
		return ok; 
}
...
function btAcaoVoltar() {
	if (acao == 'alt')
	{
		...
		$.ajax({
			dataType: 'json',
			type: 'POST',
			url: 'ajax_atendimento.php?tipo=desisteExcluir',
			data: {
