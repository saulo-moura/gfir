<?php
echo " <div onclick='return ConfirmaPrioridade_sim({$idt_atendimento_agenda});' style='color:#004080; font-size:14px; cursor:pointer; float:left; padding-top:20px; padding-left:30px; padding-right:5px;'>";
       echo " <img   title='Com Prioridade' src='imagens/imagem_com_prioridade.jpg' border='0'>";
echo " </div>";



echo " <div onclick='return ConfirmaPrioridade_nao({$idt_atendimento_agenda});' style='color:#004080; font-size:14px; cursor:pointer; float:left; padding-top:20px; padding-left:30px; padding-right:5px;'>";
...
function ConfirmaPrioridadexxxxx(idt_atendimento_agenda)
{
...
function ConfirmaPrioridade_sim(idt_atendimento_agenda)
{
   var id='tipo_pessoa';
...
function ConfirmaPrioridade(idt_atendimento_agenda)
{
