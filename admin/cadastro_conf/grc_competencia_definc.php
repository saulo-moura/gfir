...
if ($acao=='inc')
{
    ...
    else
    {
        ...
        $vetRow['grc_competencia']['data_inicial'] = trata_data($data_inicialw);
        $vetRow['grc_competencia']['data_final']   = trata_data($data_finalw);

        $ano          = substr($data_inicialw,6,4);
        $mes          = substr($data_inicialw,3,2);
        $texto        = $vetMes[$mes].'/'.$ano;
        $vetRow['grc_competencia']['ano']   = $ano;
        $vetRow['grc_competencia']['mes']   = $mes;
        $vetRow['grc_competencia']['texto']   = $texto;
        //
