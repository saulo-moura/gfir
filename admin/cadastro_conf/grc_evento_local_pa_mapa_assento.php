...
if ($_GET['idCad'] != '') {
    ...
    $botao_volta = "parent.btFechaCTC('" . $_GET['session_cod'] . "', parent.funcaoFechaCTC_grc_evento_local_pa_mapa_assento);";
    $botao_acao = '<script type="text/javascript">parent.btFechaCTC("' . $_GET['session_cod'] . '", parent.funcaoFechaCTC_grc_evento_local_pa_mapa_assento);</script>';
}

$id = 'idt';
$TabelaPai = "grc_evento_local_pa_mapa";
$AliasPai = "grc_elpam";
...
if ($_GET['id'] == 0) {
    ...
    $tabela = 'grc_evento_local_pa_mapa_assento';
