...
$idPai = "idt";
//
$TabelaPrinc = "grc_evento_cnae";
$AliasPric = "gec_apti";
$Entidade = "Atividade Econômica";
$Entidade_p = "Atividade Econômica";
...
if ($_GET['id'] == 0 || $_GET['id'] == -1 || $_POST['idorg'] == -1) {
    ...
    $vetCampo['cnae'] = objListarCmbMulti('cnae', 'gec_cnae', 'Atividade Econômica', true, '', '', '', $vetRetorno);
} else {
    $vetCampo['cnae'] = objListarCmb('cnae', 'gec_cnae', 'Atividade Econômica', true);
}
