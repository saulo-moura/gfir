...
$tabela = $TabelaPrinc;
$onSubmitDep = 'grc_atendimento_pessoa_tema_interesse_dep()';
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#idt_atendimento_pessoa_tf').html(parent.$('#nome').val());
    });

    function grc_atendimento_pessoa_tema_interesse_dep() {
        var ok = true;
        ...
        if (valida == 'S') {
            ...
            $.ajax({
                dataType: 'json',
                type: 'POST',
                url: ajax_sistema +  '?tipo=grc_atendimento_pessoa_tema_interesse_dep',
                data: {
                    cas: conteudo_abrir_sistema,
                    idt: $('#id').val(),
                    idt_atendimento_pessoa: $('#idt_atendimento_pessoa').val(),
