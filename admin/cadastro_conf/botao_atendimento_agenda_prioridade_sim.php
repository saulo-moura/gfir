<?php
echo " <div onclick='return ConfirmaPrioridade_sim({$idt_atendimento_agenda});' style='color:#004080; font-size:14px; cursor:pointer; float:left; padding-top:20px; padding-left:0px; padding-right:5px;'>";
       echo " <img   width='32' height='32' title='Com Prioridade' src='imagens/imagem_com_prioridade.png' border='0'> Com prioridade";
echo " </div>";
