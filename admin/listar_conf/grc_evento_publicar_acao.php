...
$reg_pagina_esp = 100;
$ListarBtSelecionar = 'Enviar Publicação para Aprovação';
...
$vetCampo['descricao'] = CriaVetTabela('Título Comercial', 'func_trata_dado', ftd_grc_evento);
$vetCampo['dt_previsao_inicial'] = CriaVetTabela('Data Início', 'data');
$vetCampo['dt_previsao_fim'] = CriaVetTabela('Data Término', 'data');
$vetCampo['cidade'] = CriaVetTabela('Cidade');
$vetCampo['valor_inscricao'] = CriaVetTabela('Valor', 'decimal');
$vetCampo['pubilcar_situacao'] = CriaVetTabela('Status de Publicação', 'func_trata_dado', ftd_grc_evento);
...
<script type="text/javascript">
    ...
    function ListarBtSelecionarMultiAcao() {
        ...
        if (!confirm('Deseja enviar para aprovação da publicação dos Eventos selecionados?')) {
            return false;
        }
