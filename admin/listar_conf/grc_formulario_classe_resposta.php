<?php
$idCampo = 'idt';
$Tela = "a Classe da Resposta  do Formulбrio";

$TabelaPrinc      = "grc_formulario_classe_resposta";
$AliasPric        = "grc_afa";
$Entidade         = "Classe da Resposta do Formulбrio";
$Entidade_p       = "Classe da Resposta do Formulбrio";
