...
$Filtro['rs']    = 'Texto';
$Filtro['id']    = 'f_dt_ini';
$Filtro['vlPadrao']  = Date('d/m/Y', strtotime('-1 day'));
...
$Filtro['rs']    = 'Texto';
$Filtro['id']    = 'f_dt_fim';
$Filtro['vlPadrao']  = Date('d/m/Y', strtotime('+35 day'));
...
$vetCampo['carga_horaria_total'] = CriaVetTabela('Carga<br />Horária');
$vetCampo['valor_inscricao']     = CriaVetTabela('Valor (R$)<br />Inscrição');
$vetCampo['cid_descricao']       = CriaVetTabela('Local');
...
$sql .= " cid.desccid as cid_descricao, ";
...
$sql .= "   and (e.idt_evento_situacao = 14 or e.idt_evento_situacao = 16)  ";
