...
$sql .= " left outer join " . db_pir_gec . "gec_contratacao_credenciado_ordem_rm rm on rm.idt_gec_contratacao_credenciado_ordem = ord.idt and rm.rm_cancelado = 'N'";
...
<script type="text/javascript">
    ...
    function sincronizaRM(idmov) {
        processando();

        $.ajax({
            dataType: 'json',
            type: 'POST',
            url: ajax_sistema + '?tipo=sincronizaRM',
            data: {
