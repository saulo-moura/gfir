<?php
$idCampo = 'idt';
$Tela = "a Metodologia Associada do Produto";
//
...
$AliasPric        = "grc_procp";
$Entidade         = "Metodologia Associada do Produto";
$Entidade_p       = "Metodologias Associada Associado do Produto";
...
$vetCampo['gec_pp_descricao'] = CriaVetTabela('Metodologias');
...
$sql .= " inner join grc_produto_metodologia_n gec_pp on gec_pp.idt = {$AliasPric}.idt_produto_metodologia ";
//
