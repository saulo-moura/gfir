<?php
$idCampo = 'idt';
$Tela = "o Período da Programação de Evento";
//
...
$Entidade         = "Período da Programação de Evento";
$Entidade_p       = "Períodos da Programação de evento";
...
$vetCampo['data_inicial']  = CriaVetTabela('Data Inicial <br />Programação','data');
$vetCampo['data_final']  = CriaVetTabela('Data Final <br />Programação','data');
