<?php
$idCampo = 'idt';
$Tela = "a Versão Associada ao Produto";
//
...
$AliasPric        = "grc_procp";
$Entidade         = "Versão Associada ao Produto";
$Entidade_p       = "Versões Associada ao Produto";
...
$vetCampo['gec_pp_descricao'] = CriaVetTabela('Conteúdo Programático');
