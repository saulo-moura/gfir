<?php
$idCampo = 'idt';
$Tela = "a Nota para Identificaзгo do Cliente do Funil";

$TabelaPrinc      = "grc_funil_classificacao";
$AliasPric        = "grc_fc";
$Entidade         = "Nota para Identificaзгo do Cliente do Funil";
$Entidade_p       = "Nota para Identificaзгo do Cliente do Funil";
...
$vetCampo['nota_minima'] = CriaVetTabela('Nota Mнnima', 'decimal');
