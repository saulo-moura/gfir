...
$idCampo = 'idt';
$Tela = "a Organização";
$TabelaPrinc = db_pir_gec."gec_entidade";
$AliasPric = "gec_en";
$Entidade = "Pessoa";
$Entidade_p = "Pessoas";
...
if ($includeListarCmb === true) {
    ...
    $sql .= " and gec_en.credenciado_nan = 'S'";
    $sql .= " and gec_en.ativo = 'S'";
    $sql .= " and gec_en.credenciado = 'S'";
    $sql .= " and gec_en.nan_ano = ".aspa(nan_ano);
}
