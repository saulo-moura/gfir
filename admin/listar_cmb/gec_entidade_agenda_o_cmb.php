...
$sql .= " concat_ws('', gec_en.descricao) as {$campoDescListarCmb}";
...
if ($vetFiltro['descricao']['valor'] != '') {
    $sql .= ' and gec_en.descricao = '.aspa($vetFiltro['descricao']['valor']);
}

if ($vetFiltro['resumo']['valor'] != '') {
    $sql .= ' and gec_en.resumo = '.aspa($vetFiltro['resumo']['valor']);
}
