...
$sql .= " from {$banco}gec_entidade_situacao";
...
$sql .= " gec_en.descricao as {$campoDescListarCmb}";
$sql .= " from {$banco}gec_entidade gec_en ";
$sql .= " inner join {$banco}gec_entidade_situacao  gec_es on gec_es.idt  = gec_en.idt_situacao ";
$sql .= " inner join {$banco}gec_entidade_classe gec_ec on gec_ec.idt  = gec_en.idt_entidade_classe ";
$sql .= " inner join {$banco}gec_entidade_tipo gec_et on gec_et.codigo = gec_en.tipo_entidade ";
$sql .= " where gec_en.reg_situacao = 'A'";
