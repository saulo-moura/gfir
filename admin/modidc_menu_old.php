   ...
   div#conteudo {
    ...
    div#pen_menu_OLD {
      ...
      div#pen_menu {
       ...
       xbackground: linear-gradient(to bottom, #FFFFFF 0%, #FF0000 100%,#FF0000 50%); /* W3C */
       
        background: linear-gradient(to bottom, #FFFFFF 25%, #FFFFFF 25%, #FFFFFF 50%); /* W3C */
...
$string  = " (fun.cod_classificacao    = '33.03' ";
$string .= " or fun.cod_classificacao = '33.05' ";
$string .= " or fun.cod_classificacao = '33.11' ";
$string .= " or fun.cod_classificacao = '39' ";
$string .= " or fun.cod_classificacao = '41')  ";
...
$sql .= '  fun.*   ';
$sql .= '  from funcao fun ';
$sql .= '  where ( fun.painel like '.aspa($cod_modw);
$sql .= "    ) ";
//$sql .= '  where '.$string;
$sql .= "    and sts_menu='S' ";
$sql .= "    and linha > 0 ";
...
echo '<table border="0" cellpadding="0" width="98%" cellspacing="0" class="Sub_Menu">';
//
$num_col_tab   = 8;
