...
if ($_GET['instrumento'] == 1) {   // informação
    $idt_instrumento = 8;
}
if ($_GET['instrumento'] == 2) {   // orientação técnica
    $idt_instrumento = 13;
}
if ($_GET['instrumento'] == 3) {   // consultoria
    $idt_instrumento = 2;
}
...
if ($opcao == 'inc') {
    if ($_SESSION[CS]['g_atendimento_relacao'] == '') {
        ?>
        <script type="text/javascript">
            alert('Não pode fazer um atendimento, pois o usuário não tem relacionamento com o PA!');
            self.location = "<?php echo $_SESSION[CS]['grc_atendimento_avulso']; ?>";
        </script>
        <?php
        exit();
    }
...
<script type="text/javascript">
    ...
    function EscondeCadastro()
    {
        ...
        var href = "conteudo.php?prefixo=inc&menu=grc_atender_cliente&idt_atendimento_agenda=" + idt_atendimento_agenda + "&idt_atendimento=" + idt_atendimento + "&id=" + idt_atendimento_agenda + "&aba=2";
        self.location = href;
    ...
    function EscondeAtendimento()
    {
        ...
        var href = "conteudo.php?prefixo=inc&menu=grc_atender_cliente&idt_atendimento_agenda=" + idt_atendimento_agenda + "&idt_atendimento=" + idt_atendimento + "&id=" + idt_atendimento_agenda + "&aba=1";
        self.location = href;
        return false;
