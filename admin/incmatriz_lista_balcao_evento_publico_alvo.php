...
function CriarDimensoesAtendimento(&$vetDimensao) {
	...
	// Público Alvo
	$vetPublicoAlvo=Aarray()
	$vetPublicoAlvo['PF']  ='Pessoa Física';
	$vetPublicoAlvo['MEI'] ='Microempreendedor Individual';
	$vetPublicoAlvo['ME']  ='Micro Empresa';
	$vetPublicoAlvo['EPP'] ='Empresa de Pequeno Porte';
    $vetDimensao['PontoAtendimento'] = $vetPontoAtendimento;
    $vetDimensao['Instrumento']      = $vetInstrumento;
	$vetDimensao['UR']               = $vetPontoUR;
	$vetDimensao['PublicoAlvo']      = $vetPublicoAlvo;
    return $kokw;
}
...
$PublicoAlvo           = $vetDimensao['PublicoAlvo'];
...
$vetPorte=Array();
$vetPorte[0] ='PE'; //Potencial Empresário
$vetPorte[1]='EPP'; //Empresa de Pequeno Porte
$vetPorte[3]='ME';  //Microempresa
$vetPorte[5]='MEI'; //Microempreendedor Individual
$vetPorte[2]='PP';  //Média Empresa
