...
<?php
 ...
 echo ' <div id="barra_topo_m"> ';
    ...
    echo '       <a id="retornar_a" href="javascript:top.close();" title="Clique aqui retornar"><img alt="" src="imagens/sair.png" width="32" height="32"></a>';
    echo ' </div>  ';
    echo "<div  style=''>";
    echo "<center>";
    $titulo_modulo="";
	...
	//$prefixo = 'cadastro';
	//$acao    = 'alt';
    $Require_Once="cadastro_conf/grc_nan_protocolo_segunda_visita.php";
