...
function CriarDimensoesAtendimentoMeta5(&$vetDimensao) {
    $kokw = 0;
	$vetPontoUR = Array();
...
function QuantitativosAtendimentoMeta5($vetInstrumento,$vetPontoUR,$idt_dimensao, $condicao, &$vetDimensao, &$vetDimensaoTotal, &$TotalGeral_G, &$vetDimensaoInstrumento, &$vetDimensaoTempoI, &$vetDimensaoTempoP,$op,&$vetMensal,&$vetEst) {
    //$vetDimensao = Array();
	...
	$condicao .= " and meta5 ='S' and ordem_cnpj = 1  ";
...
$condicao       = ""; // todos os produtos
QuantitativosAtendimentoMeta5($vetInstrumento,$vetPontoUR,$idt_dimensao, $condicao, $vetDimensao,$vetDimensaoTotal,$TotalGeral_G, $vetDimensaoInstrumento, $vetDimensaoTempoI, $vetDimensaoTempoP,1,$vetMensal,$vetEst);
...
$condicao       = ""; // todos os produtos
QuantitativosAtendimentoMeta5($vetInstrumento,$vetPontoUR,$idt_dimensao, $condicao, $vetDimensao,$vetDimensaoTotal,$TotalGeral_G, $vetDimensaoInstrumento, $vetDimensaoTempoI, $vetDimensaoTempoP,2,$vetMensal,$vetEst);
...
echo "Meta 5 - Atendimentos a Pequenos Negócios - EPP ";
echo "</div>";
...
$metaanual = $vetMetasValorAnual['MM5'];
...
$onclick = " onclick='return AbreFechaM5(0);'; ";
$title = " title='Clique aqui para exibir ou esconder o Gráfico' ";
echo  "<div id='grafico0M5' {$onclick} style=''>";
echo  "<div id='grafico0tM5' {$title} style='padding-left:5px; border-bottom:1px solid #FFFFFF; cursor:pointer; float:left; width:100%; height:30px; background:#2A5696; color:#FFFFFF;'>";
echo  "1 - Público Sebrae";
echo  "</div>";
echo  "<div id='container_grafico0M5' style='display:none; float:left; width:100%; height:{$altura}px; margin-top:10px; border-top:3px solid #2A5696;'></div>";
echo "</div>";
...
$onclick = " onclick='return AbreFechaM5(1);'; ";
$title = " title='Clique aqui para exibir ou esconder o Gráfico' ";
echo  "<div id='grafico1M5' {$onclick} style=''>";
echo  "<div id='grafico1tM5' {$title} style='padding-left:5px; border-bottom:1px solid #FFFFFF; cursor:pointer; float:left; width:100%; height:30px; background:#2A5696; color:#FFFFFF;'>";
echo  "2 - Atendimentos - Curva ABC";
echo  "</div>";
echo  "<div id='container_grafico1M5' style='display:none; float:left; width:100%; height:{$altura}px; margin-top:10px; border-top:3px solid #2A5696;'></div>";
echo "</div>";
...
$onclick = " onclick='return AbreFechaM5(3);'; ";
echo  "<div id='grafico3M5' {$onclick} style=''>";
echo  "<div id='grafico3tM5' {$title} style='padding-left:5px; border-bottom:1px solid #FFFFFF; cursor:pointer; float:left; width:100%; height:30px; background:#2A5696; color:#FFFFFF;'>";
echo  "3 - Unidades Regionais - Atendimento por Instrumento";
echo  "</div>";
echo  "<div id='container_grafico3M5' style='display:none; float:left; width:100%; height:{$altura}px; margin-top:10px; border-top:3px solid #2A5696; border-bottom:3px solid #2A5696;'></div>";
echo "</div>";


$onclick = " onclick='return AbreFechaM5(2);'; ";
echo  "<div id='grafico2M5' {$onclick} style=''>";
echo  "<div id='grafico2tM5' {$title} style='padding-left:5px; border-bottom:1px solid #FFFFFF; cursor:pointer; float:left; width:100%; height:30px; background:#2A5696; color:#FFFFFF;'>";
echo  "4 - Atendimentos Mensal - Quantidade";
echo  "</div>";
echo  "<div id='container_grafico2M5' style='display:none; float:left; width:100%; height:{$altura}px; margin-top:10px; border-top:3px solid #2A5696; border-bottom:3px solid #2A5696;'></div>";
echo  "</div>";



$onclick = " onclick='return AbreFechaM5(4);'; ";
echo  "<div id='grafico4M5' {$onclick} style=''>";
echo  "<div id='grafico4tM5' {$title} style='padding-left:5px; border-bottom:1px solid #FFFFFF; cursor:pointer; float:left; width:100%; height:30px; background:#2A5696; color:#FFFFFF;'>";
echo  "5 - Atendimentos por Instrumento - Geral";
echo  "</div>";
echo  "<div id='container_grafico4M5' style='display:none; float:left; width:100%; height:{$altura}px; margin-top:10px; border-top:3px solid #2A5696; border-bottom:3px solid #2A5696;'></div>";
echo  "</div>";
...
$(document).ready(function() {
    ...
    chartM5 = new Highcharts.Chart({
        chart: {
		    renderTo: 'container_grafico0M5',
            type: 'bar'
        },
        title: {
		    margin:		    50,
	...
	/////////////////// grafico 2
	 chart2M5 = new Highcharts.Chart({
        chart: {
		    renderTo: 'container_grafico2M5',
            type: 'line'
        },
        title: {
		    margin:		    50,
	...
	// grafico 3
	 ...
	 chart3M5 = new Highcharts.Chart({
        chart: {
		    renderTo: 'container_grafico3M5',
			marginBottom: 300,
            type: 'line'
        },
        title: {
...
?>		
	...
	// grafico 4
	 ...
	 chart4M5 = new Highcharts.Chart({
        chart: {
		    renderTo: 'container_grafico4M5',
			// marginBottom: 300,
            type: 'bar'
        },
        title: {
...
*/
function AbreFechaM5(op)
{
    var id = "#container_grafico"+op+'M5';
    $(id).toggle();  
	return false;
}
