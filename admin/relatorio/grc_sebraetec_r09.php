...
if (!in_array("motivo_proposta", $_POST['sql_groupby'])) {
    $vetd = Array();
    $vetd[2]['campo'] = "motivo_proposta";
    $vetd[2]['descricao'] = "Motivo para não apresentar a Proposta";
    $vetd[2]['cor'] = "";
    $vetd[2]['tamanho'] = "";
    $vet[] = $vetd;
}
...
if ($_GET['print'] != 's') {
    ...
    $nome_relatorio = 'RELATÓRIO APRESENTAÇÃO DE PROPOSTAS';
...
// Vetor Ordenação: TODO Ajustar de acordo colunas
$vetOrderby = Array();
