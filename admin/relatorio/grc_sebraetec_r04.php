...
if (!in_array("valor_servico", $_POST['sql_groupby'])) {
    ...
    $vetd[1]['descricao'] = "Valor do Serviço Contratado";
    $vetd[1]['cor'] = "";
    $vetd[1]['tamanho'] = "";
...
if (!in_array("qtd_dias_execucao_servico", $_POST['sql_groupby'])) {
    ...
    $vetd[1]['descricao'] = "Quantidade de dias para execução dos serviços";
    $vetd[1]['cor'] = "";
    $vetd[1]['tamanho'] = "";
    $vetd[1]['styleC'] = " text-align:right; padding-right:10px; ";
    $vet[] = $vetd;
...
//    echo $sql;
    ...
    if ($qtd_sel == 0) {
        ...
        // obter dados para impressão

        $vet = Array();
        //$vet['titulo']  = "Relatório 3";
        //$vet['largura'] = "1500px";
