...
$vetOrdenacao = Array(
    'us.nome_completo,em.descricao' => 'Nome do Usuário',
    'us.login,em.descricao' => 'Login do Usuário',
    'em.descricao,us.nome_completo' => 'Empreendimento',
    'pe.nm_perfil,us.nome_completo,em.descricao' => 'Perfil - GC',
    'pes.nm_perfil,us.nome_completo,em.descricao' => 'Perfil - Site',
    'pesa.nm_perfil,us.nome_completo,em.descricao' => 'Perfil - Assinatura',
...
$sql = 'select
               ...
               pes.nm_perfil    as pes_nm_perfil,
               pesa.nm_perfil   as pesa_nm_perfil,
               us.dt_validade   as us_dt_validade,
               us.email         as us_email,
               em.descricao     as em_descricao

        from usuario as us


        inner join perfil                   as pe   on us.id_perfil            = pe.id_perfil
        left  join site_perfil              as pes  on us.id_site_perfil       = pes.id_perfil
        left  join site_perfil_assinatura   as pesa on us.idt_site_perfil_assi = pesa.id_perfil
        
        inner join usuario_assinatura  ua  on us.id_usuario = ua.id_usuario
        inner join empreendimento em  on ua.idt_empreendimento = em.idt ';
   ...
   $sql = $sql.$kwherew.$korderbyw;
    ...
    if ($kpriw==1)
    {
        ...
        echo "<tr class='linha_cab_tabela'>  ";
        echo "   <td>&nbsp;Nome</td> ";
        echo "   <td>&nbsp;Empreendimento</td>  ";
        echo "   <td>&nbsp;Login</td> ";
        echo "   <td>&nbsp;Perfil<br /> GC</td> ";
        echo "   <td>&nbsp;Perfil<br /> Site</td> ";
        echo "   <td>&nbsp;Perfil<br /> Assinatura</td> ";
        echo "   <td>&nbsp;Ativo</td>  ";
      //  echo "   <td>&nbsp;Tipo</td> ";
     ...
     echo "<tr class= 'linha_tabela'>";
        ...
        $us_login  = $row['us_login'];
        $vet_login = explode('@',$us_login);
        $us_login  = $vet_login[0];
        echo "<td class='linha_tabela'>".$row['us_nome_completo']."&nbsp;</td>";
        echo "<td class='linha_tabela'>".$row['em_descricao']."&nbsp;</td>";
        echo "<td class='linha_tabela'>".$us_login."&nbsp;</td>";
        echo "<td class='linha_tabela'>".$row['pe_nm_perfil']."&nbsp;</td>";
        
        echo "<td class='linha_tabela'>".$row['pes_nm_perfil']."&nbsp;</td>";
        echo "<td class='linha_tabela'>".$row['pesa_nm_perfil']."&nbsp;</td>";
 ...
 //  {
        ...
        echo "<tr align='left'>";
        echo "<td><b>Total de Linhas:&nbsp;&nbsp;".$totusuariosw."</b></td>";
        echo "</tr>";
        echo "</table>";
 //   }
