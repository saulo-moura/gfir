...
if (!in_array("codigo_crm", $_POST['sql_groupby'])) {
    $vetd = Array();
    $vetd[1]['campo'] = "codigo_crm";
    $vetd[1]['descricao'] = "Código CRM";
    $vetd[1]['cor'] = "";
    $vetd[1]['tamanho'] = "";
    $vet[] = $vetd;
}
...
if (!in_array("gestor_evento", $_POST['sql_groupby'])) {
    ...
    $vetd[2]['descricao'] = "Responsável Evento";
    $vetd[2]['cor'] = "";
    $vetd[2]['tamanho'] = "";
    $vet[] = $vetd;
}
...
if (!in_array("media_preco_praticados", $_POST['sql_groupby'])) {
    $vetd = Array();
    $vetd[1]['campo'] = "media_preco_praticados";
    $vetd[1]['descricao'] = "Média dos preços praticados";
    $vetd[1]['cor'] = "";
    $vetd[1]['tamanho'] = "";
...
if (!in_array("pst", $_POST['sql_groupby'])) {
    $vetd = Array();
    $vetd[1]['campo'] = "pst";
    $vetd[1]['descricao'] = "PST";
    $vetd[1]['cor'] = "";
    $vetd[1]['tamanho'] = "";
    $vet[] = $vetd;
}
...
if ($_GET['print'] != 's') {
    ...
    $nome_relatorio = 'RELATÓRIO PREÇOS PRATICADOS';
