...
if (!in_array("area_tematica", $_POST['sql_groupby'])) {
    $vetd = Array();
    $vetd[2]['campo'] = "area_tematica";
    $vetd[2]['descricao'] = "Área Temática";
    $vetd[2]['cor'] = "";
    $vetd[2]['tamanho'] = "";
    $vet[] = $vetd;
}
...
if ($_GET['print'] != 's') {
    ...
    $nome_relatorio = 'RELATÓRIO CREDENCIADOS POR ÁREA/SUBÁREA /PRODUTO';
