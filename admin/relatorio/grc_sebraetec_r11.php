...
if (!in_array("codigo_crm", $_POST['sql_groupby'])) {
    $vetd = Array();
    $vetd[2]['campo'] = "codigo_crm";
    $vetd[2]['descricao'] = "Código CRM";
    $vetd[2]['cor'] = "";
    $vetd[2]['tamanho'] = "";
    $vet[] = $vetd;
}
...
if (!in_array("projeto_acao", $_POST['sql_groupby'])) {
    $vetd = Array();
    $vetd[1]['campo'] = "projeto_acao";
    $vetd[1]['descricao'] = "Projeto/Ação";
    $vetd[1]['cor'] = "";
    $vetd[1]['tamanho'] = "";
    $vet[] = $vetd;
}
...
if ($_GET['print'] != 's') {
    ...
    $nome_relatorio = 'RELATÓRIO EXECUÇÃO FÍSICA E ORÇAMENTÁRIA';
