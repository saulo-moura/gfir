...
if ($txt_orcamento=='')
{
    echo ' Atenção... Arquivo TXT para IMPORTAÇÃO, NÃO INFORMADO. '."<br />";
    echo ' IMPORTAÇÃO NÃO EXECUTADA. '."<br />";
    exit();
}


//$arquivo = "obj_file/importar_txt/orçamento analitico.txt";

$dirtxt    = "obj_file/orcamentos_empreendimento/";


//$name_txt  = "orçamento analitico.txt";
...
foreach($vetlinha as $cpos) {
     ...
     $rs = execsql($sql);
     echo ' Importando Classificação == '.$class;
     if ($rs->rows == 0)
     {
...
echo '<br />**** Fim Normal da Conversão ****'.'<br />';
