...
$hint0    = " title = 'Clique aqui para Visualizar a Geral' ";
$onclickA = " onclick = 'return op0();' ";
echo "<div id='op0' class='op' {$onclickA} {$hint0} >";
echo "   <a  class='op_a' style=''>Geral</a> ";
echo "</div>";



$hint1    = " title = 'Clique aqui para Visualizar Meta 1 - Atendimento a Pequenos Negócios' ";
$onclickA = " onclick = 'return op1();' ";
echo "<div id='op1' class='op' {$onclickA} {$hint1} >";
echo "   <a  class='op_a' style=''>1 - PN</a> ";
echo "</div>";

$onclickA = " onclick = 'return op2();' ";
$hint2    = "title = 'Clique aqui para Visualizar Atendimento a Pequenos Negócios com solução Específicas de Inovação'";
echo "<div id='op2' class='op' {$onclickA} {$hint2} >";
echo "   <a  class='op_a' style=''>2 - PN - Inovação</a> ";
echo "</div>";

$onclickA = " onclick = 'return op3();' ";
$hint3    = "title = 'Clique aqui para Visualizar Atendimento a Microempreendedores Individuais'";
echo "<div id='op3' class='op' {$onclickA} {$hint3} >";
echo "   <a  class='op_a' style=''>3 - MEI</a> ";
echo "</div>";

$onclickA = " onclick = 'return op4();' ";
$hint4    = "title = 'Clique aqui para Visualizar Atendimento a Microempresas'";
echo "<div id='op4' class='op' {$onclickA} {$hint4} >";
echo "   <a  class='op_a' style=''>4 - ME</a> ";
echo "</div>";

$onclickA = " onclick = 'return op5();' ";
$hint5    = "title = 'Clique aqui para Visualizar Atendimento a Empresas de Pequeno Porte'";
echo "<div id='op4' class='op' {$onclickA} {$hint5} >";
echo "   <a  class='op_a' style=''>5 - EPP </a> ";
echo "</div>";
...
$vetMetasValorAnual['GE']=420000; // Meta Geral Bruta
$vetMetasValorAnual['MM1']=132412; // Meta Mobilizadora 1
$vetMetasValorAnual['MM2']=12245;  // Meta Mobilizadora 2
$vetMetasValorAnual['MM3']=80576;  // Meta Mobilizadora 3
$vetMetasValorAnual['MM4']=42990;  // Meta Mobilizadora 4
$vetMetasValorAnual['MM5']=8843;   // Meta Mobilizadora 5
$vetMetasValorAnual['MM7']=42851;  // Meta Mobilizadora 7
...
$chamar       = "incmatriz_lista_balcao_evento";
