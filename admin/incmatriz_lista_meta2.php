...
function CriarDimensoesAtendimentoMeta2(&$vetDimensao) {
    $kokw = 0;
	$vetPontoUR = Array();
...
function QuantitativosAtendimentoMeta2($vetInstrumento,$vetPontoUR,$idt_dimensao, $condicao, &$vetDimensao, &$vetDimensaoTotal, &$TotalGeral_G, &$vetDimensaoInstrumento, &$vetDimensaoTempoI, &$vetDimensaoTempoP,$op,&$vetMensal,&$vetEst) {
    //$vetDimensao = Array();
	...
	$condicao .= " and meta2 ='S' and ordem_cnpj = 1  ";
...
$vetInstrumento        = Array();
$vetDimensao           = Array();
$ret = CriarDimensoesAtendimentoMeta2($vetDimensao);
...
$condicao       = ""; // todos os produtos
QuantitativosAtendimentoMeta2($vetInstrumento,$vetPontoUR,$idt_dimensao, $condicao, $vetDimensao,$vetDimensaoTotal,$TotalGeral_G, $vetDimensaoInstrumento, $vetDimensaoTempoI, $vetDimensaoTempoP,1,$vetMensal,$vetEst);
...
$condicao       = ""; // todos os produtos
QuantitativosAtendimentoMeta2($vetInstrumento,$vetPontoUR,$idt_dimensao, $condicao, $vetDimensao,$vetDimensaoTotal,$TotalGeral_G, $vetDimensaoInstrumento, $vetDimensaoTempoI, $vetDimensaoTempoP,2,$vetMensal,$vetEst);
...
echo "<div id='meta2_titulo' class='cb_titulo_meta'>";
echo "Meta 2 - Atendimentos a Pequenos Negócios - Inovação";
echo "</div>";
...
$metaanual = $vetMetasValorAnual['MM2'];
...
$onclick = " onclick='return AbreFechaM2(0);'; ";
$title = " title='Clique aqui para exibir ou esconder o Gráfico' ";
echo  "<div id='grafico0M2' {$onclick} style=''>";
echo  "<div id='grafico0tM2' {$title} style='padding-left:5px; border-bottom:1px solid #FFFFFF; cursor:pointer; float:left; width:100%; height:30px; background:#2A5696; color:#FFFFFF;'>";
echo  "1 - Público Sebrae";
echo  "</div>";
echo  "<div id='container_grafico0M2' style='display:none; float:left; width:100%; height:{$altura}px; margin-top:10px; border-top:3px solid #2A5696;'></div>";
echo "</div>";
...
$onclick = " onclick='return AbreFechaM2(1);'; ";
$title = " title='Clique aqui para exibir ou esconder o Gráfico' ";
echo  "<div id='grafico1M2' {$onclick} style=''>";
echo  "<div id='grafico1tM2' {$title} style='padding-left:5px; border-bottom:1px solid #FFFFFF; cursor:pointer; float:left; width:100%; height:30px; background:#2A5696; color:#FFFFFF;'>";
echo  "2 - Atendimentos - Curva ABC";
echo  "</div>";
echo  "<div id='container_grafico1M2' style='display:none; float:left; width:100%; height:{$altura}px; margin-top:10px; border-top:3px solid #2A5696;'></div>";
echo "</div>";
...
$onclick = " onclick='return AbreFechaM2(3);'; ";
echo  "<div id='grafico3M2' {$onclick} style=''>";
echo  "<div id='grafico3tM2' {$title} style='padding-left:5px; border-bottom:1px solid #FFFFFF; cursor:pointer; float:left; width:100%; height:30px; background:#2A5696; color:#FFFFFF;'>";
echo  "3 - Unidades Regionais - Atendimento por Instrumento";
echo  "</div>";
echo  "<div id='container_grafico3M2' style='display:none; float:left; width:100%; height:{$altura}px; margin-top:10px; border-top:3px solid #2A5696; border-bottom:3px solid #2A5696;'></div>";
echo "</div>";


$onclick = " onclick='return AbreFechaM2(2);'; ";
echo  "<div id='grafico2M2' {$onclick} style=''>";
echo  "<div id='grafico2tM2' {$title} style='padding-left:5px; border-bottom:1px solid #FFFFFF; cursor:pointer; float:left; width:100%; height:30px; background:#2A5696; color:#FFFFFF;'>";
echo  "4 - Atendimentos Mensal - Quantidade";
echo  "</div>";
echo  "<div id='container_grafico2M2' style='display:none; float:left; width:100%; height:{$altura}px; margin-top:10px; border-top:3px solid #2A5696; border-bottom:3px solid #2A5696;'></div>";
echo  "</div>";



$onclick = " onclick='return AbreFechaM2(4);'; ";
echo  "<div id='grafico4M2' {$onclick} style=''>";
echo  "<div id='grafico4tM2' {$title} style='padding-left:5px; border-bottom:1px solid #FFFFFF; cursor:pointer; float:left; width:100%; height:30px; background:#2A5696; color:#FFFFFF;'>";
echo  "5 - Atendimentos por Instrumento - Geral";
echo  "</div>";
echo  "<div id='container_grafico4M2' style='display:none; float:left; width:100%; height:{$altura}px; margin-top:10px; border-top:3px solid #2A5696; border-bottom:3px solid #2A5696;'></div>";
echo  "</div>";
...
$(document).ready(function() {
    ...
    chartM2 = new Highcharts.Chart({
        chart: {
		    renderTo: 'container_grafico0M2',
            type: 'bar'
        },
        title: {
		    margin:		    50,
	...
	/////////////////// grafico 2
	 chart2M2 = new Highcharts.Chart({
        chart: {
		    renderTo: 'container_grafico2M2',
            type: 'line'
        },
        title: {
		    margin:		    50,
	...
	// grafico 3
	 ...
	 chart3M2 = new Highcharts.Chart({
        chart: {
		    renderTo: 'container_grafico3M2',
			marginBottom: 300,
            type: 'line'
        },
        title: {
...
?>		
	...
	// grafico 4
	 ...
	 chart4M2 = new Highcharts.Chart({
        chart: {
		    renderTo: 'container_grafico4M2',
			// marginBottom: 300,
            type: 'bar'
        },
        title: {
...
*/
function AbreFechaM2(op)
{
    var id = "#container_grafico"+op+'M2';
    $(id).toggle();  
	return false;
}
