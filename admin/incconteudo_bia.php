...
echo "<div id='p1' style='width:30%; float:left;' >";
...
echo "</div>"; // id='p1' style='width:40%; float:left;' >";


echo "<div id='p2' style='xwidth:100%; xbackground:red; xheight:300px;' >";
//echo " aqui vai a coisa do conteudo>";
