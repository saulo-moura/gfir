...
{
    $g_idt_obra_tt=$_SESSION[CS]['g_idt_obra'];
}
...
$sql .= ' where em.idt = '.null($g_idt_obra_tt);
$rs = execsql($sql);
...
//ImagemMostrar(865, 380, $path, $img, $nm_empreendimento, false, 'idt="'.$idt.'"');
