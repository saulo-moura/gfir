...
function CriarDimensoesAtendimentoMeta(&$vetDimensao) {
    $kokw = 0;
	$vetPontoUR = Array();
...
function QuantitativosAtendimentoMeta($vetInstrumento,$vetPontoUR,$idt_dimensao, $condicao, &$vetDimensao, &$vetDimensaoTotal, &$TotalGeral_G, &$vetDimensaoInstrumento, &$vetDimensaoTempoI, &$vetDimensaoTempoP,$op,&$vetMensal,&$vetEst) {
    //$vetDimensao = Array();
	...
	//$condicao .= " and meta1 ='S' and req_intensidade = 'S'  ";
	
	$condicao .= " and meta1 ='S' and ordem_cnpj = 1  ";
...
$vetInstrumento        = Array();
$vetDimensao           = Array();
$ret = CriarDimensoesAtendimentoMeta($vetDimensao);
...
$condicao       = ""; // todos os produtos
QuantitativosAtendimentoMeta($vetInstrumento,$vetPontoUR,$idt_dimensao, $condicao, $vetDimensao,$vetDimensaoTotal,$TotalGeral_G, $vetDimensaoInstrumento, $vetDimensaoTempoI, $vetDimensaoTempoP,1,$vetMensal,$vetEst);
...
$condicao       = ""; // todos os produtos
QuantitativosAtendimentoMeta($vetInstrumento,$vetPontoUR,$idt_dimensao, $condicao, $vetDimensao,$vetDimensaoTotal,$TotalGeral_G, $vetDimensaoInstrumento, $vetDimensaoTempoI, $vetDimensaoTempoP,2,$vetMensal,$vetEst);
...
echo "Meta 1 - Atendimentos a Pequenos Negócios";
echo "</div>";
...
$metaanual = $vetMetasValorAnual['MM1'];
...
$onclick = " onclick='return AbreFechaM1(0);'; ";
$title = " title='Clique aqui para exibir ou esconder o Gráfico' ";
echo  "<div id='grafico0M1' {$onclick} style=''>";
echo  "<div id='grafico0tM1' {$title} style='padding-left:5px; border-bottom:1px solid #FFFFFF; cursor:pointer; float:left; width:100%; height:30px; background:#2A5696; color:#FFFFFF;'>";
echo  "1 - Público Sebrae";
echo  "</div>";
echo  "<div id='container_grafico0M1' style='display:none; float:left; width:100%; height:{$altura}px; margin-top:10px; border-top:3px solid #2A5696;'></div>";
echo "</div>";
...
$onclick = " onclick='return AbreFechaM1(1);'; ";
$title = " title='Clique aqui para exibir ou esconder o Gráfico' ";
echo  "<div id='grafico1M1' {$onclick} style=''>";
echo  "<div id='grafico1tM1' {$title} style='padding-left:5px; border-bottom:1px solid #FFFFFF; cursor:pointer; float:left; width:100%; height:30px; background:#2A5696; color:#FFFFFF;'>";
echo  "2 - Atendimentos - Curva ABC";
echo  "</div>";
echo  "<div id='container_grafico1M1' style='display:none; float:left; width:100%; height:{$altura}px; margin-top:10px; border-top:3px solid #2A5696;'></div>";
echo "</div>";
...
$onclick = " onclick='return AbreFechaM1(3);'; ";
echo  "<div id='grafico3M1' {$onclick} style=''>";
echo  "<div id='grafico3tM1' {$title} style='padding-left:5px; border-bottom:1px solid #FFFFFF; cursor:pointer; float:left; width:100%; height:30px; background:#2A5696; color:#FFFFFF;'>";
echo  "3 - Unidades Regionais - Atendimento por Instrumento";
echo  "</div>";
echo  "<div id='container_grafico3M1' style='display:none; float:left; width:100%; height:{$altura}px; margin-top:10px; border-top:3px solid #2A5696; border-bottom:3px solid #2A5696;'></div>";
echo "</div>";


$onclick = " onclick='return AbreFechaM1(2);'; ";
echo  "<div id='grafico2M1' {$onclick} style=''>";
echo  "<div id='grafico2tM1' {$title} style='padding-left:5px; border-bottom:1px solid #FFFFFF; cursor:pointer; float:left; width:100%; height:30px; background:#2A5696; color:#FFFFFF;'>";
echo  "4 - Atendimentos Mensal - Quantidade";
echo  "</div>";
echo  "<div id='container_grafico2M1' style='display:none; float:left; width:100%; height:{$altura}px; margin-top:10px; border-top:3px solid #2A5696; border-bottom:3px solid #2A5696;'></div>";
echo  "</div>";



$onclick = " onclick='return AbreFechaM1(4);'; ";
echo  "<div id='grafico4M1' {$onclick} style=''>";
echo  "<div id='grafico4tM1' {$title} style='padding-left:5px; border-bottom:1px solid #FFFFFF; cursor:pointer; float:left; width:100%; height:30px; background:#2A5696; color:#FFFFFF;'>";
echo  "5 - Atendimentos por Instrumento - Geral";
echo  "</div>";
echo  "<div id='container_grafico4M1' style='display:none; float:left; width:100%; height:{$altura}px; margin-top:10px; border-top:3px solid #2A5696; border-bottom:3px solid #2A5696;'></div>";
echo  "</div>";
...
$(document).ready(function() {
    ...
    chartM1 = new Highcharts.Chart({
        chart: {
		    renderTo: 'container_grafico1M1',
            type: 'bar'
        },
        title: {
		    margin:		    50,
	...
	// grafico 3
	 ...
	 chart3M1 = new Highcharts.Chart({
        chart: {
		    renderTo: 'container_grafico3M1',
			marginBottom: 300,
            type: 'line'
        },
        title: {
...
?>		
	...
	// grafico 4
	 ...
	 chart4M1 = new Highcharts.Chart({
        chart: {
		    renderTo: 'container_grafico4M1',
			// marginBottom: 300,
            type: 'bar'
        },
        title: {
...
*/
function AbreFechaM1(op)
{
    var id = "#container_grafico"+op+'M1';
    $(id).toggle();  
	return false;
}
