...
function CriarDimensoesAtendimentoMeta4(&$vetDimensao) {
    $kokw = 0;
	$vetPontoUR = Array();
...
function QuantitativosAtendimentoMeta4($vetInstrumento,$vetPontoUR,$idt_dimensao, $condicao, &$vetDimensao, &$vetDimensaoTotal, &$TotalGeral_G, &$vetDimensaoInstrumento, &$vetDimensaoTempoI, &$vetDimensaoTempoP,$op,&$vetMensal,&$vetEst) {
    //$vetDimensao = Array();
	...
	$condicao .= " and meta4 ='S' and ordem_cnpj = 1  ";
...
$condicao       = ""; // todos os produtos
QuantitativosAtendimentoMeta4($vetInstrumento,$vetPontoUR,$idt_dimensao, $condicao, $vetDimensao,$vetDimensaoTotal,$TotalGeral_G, $vetDimensaoInstrumento, $vetDimensaoTempoI, $vetDimensaoTempoP,1,$vetMensal,$vetEst);
...
$condicao       = ""; // todos os produtos
QuantitativosAtendimentoMeta4($vetInstrumento,$vetPontoUR,$idt_dimensao, $condicao, $vetDimensao,$vetDimensaoTotal,$TotalGeral_G, $vetDimensaoInstrumento, $vetDimensaoTempoI, $vetDimensaoTempoP,2,$vetMensal,$vetEst);
...
echo "Meta 4 - Atendimentos a Pequenos Negócios - ME ";
echo "</div>";
...
$metaanual = $vetMetasValorAnual['MM4'];
...
$onclick = " onclick='return AbreFechaM4(0);'; ";
$title = " title='Clique aqui para exibir ou esconder o Gráfico' ";
echo  "<div id='grafico0M4' {$onclick} style=''>";
echo  "<div id='grafico0tM4' {$title} style='padding-left:5px; border-bottom:1px solid #FFFFFF; cursor:pointer; float:left; width:100%; height:30px; background:#2A5696; color:#FFFFFF;'>";
echo  "1 - Público Sebrae";
echo  "</div>";
echo  "<div id='container_grafico0M4' style='display:none; float:left; width:100%; height:{$altura}px; margin-top:10px; border-top:3px solid #2A5696;'></div>";
echo "</div>";
...
$onclick = " onclick='return AbreFechaM4(1);'; ";
$title = " title='Clique aqui para exibir ou esconder o Gráfico' ";
echo  "<div id='grafico1M4' {$onclick} style=''>";
echo  "<div id='grafico1tM4' {$title} style='padding-left:5px; border-bottom:1px solid #FFFFFF; cursor:pointer; float:left; width:100%; height:30px; background:#2A5696; color:#FFFFFF;'>";
echo  "2 - Atendimentos - Curva ABC";
echo  "</div>";
echo  "<div id='container_grafico1M4' style='display:none; float:left; width:100%; height:{$altura}px; margin-top:10px; border-top:3px solid #2A5696;'></div>";
echo "</div>";
...
$onclick = " onclick='return AbreFechaM4(3);'; ";
echo  "<div id='grafico3M4' {$onclick} style=''>";
echo  "<div id='grafico3tM4' {$title} style='padding-left:5px; border-bottom:1px solid #FFFFFF; cursor:pointer; float:left; width:100%; height:30px; background:#2A5696; color:#FFFFFF;'>";
echo  "3 - Unidades Regionais - Atendimento por Instrumento";
echo  "</div>";
echo  "<div id='container_grafico3M4' style='display:none; float:left; width:100%; height:{$altura}px; margin-top:10px; border-top:3px solid #2A5696; border-bottom:3px solid #2A5696;'></div>";
echo "</div>";


$onclick = " onclick='return AbreFechaM4(2);'; ";
echo  "<div id='grafico2M4' {$onclick} style=''>";
echo  "<div id='grafico2tM4' {$title} style='padding-left:5px; border-bottom:1px solid #FFFFFF; cursor:pointer; float:left; width:100%; height:30px; background:#2A5696; color:#FFFFFF;'>";
echo  "4 - Atendimentos Mensal - Quantidade";
echo  "</div>";
echo  "<div id='container_grafico2M4' style='display:none; float:left; width:100%; height:{$altura}px; margin-top:10px; border-top:3px solid #2A5696; border-bottom:3px solid #2A5696;'></div>";
echo  "</div>";



$onclick = " onclick='return AbreFechaM4(4);'; ";
echo  "<div id='grafico4M4' {$onclick} style=''>";
echo  "<div id='grafico4tM4' {$title} style='padding-left:5px; border-bottom:1px solid #FFFFFF; cursor:pointer; float:left; width:100%; height:30px; background:#2A5696; color:#FFFFFF;'>";
echo  "5 - Atendimentos por Instrumento - Geral";
echo  "</div>";
echo  "<div id='container_grafico4M4' style='display:none; float:left; width:100%; height:{$altura}px; margin-top:10px; border-top:3px solid #2A5696; border-bottom:3px solid #2A5696;'></div>";
echo  "</div>";
...
$(document).ready(function() {
    ...
    chartM4 = new Highcharts.Chart({
        chart: {
		    renderTo: 'container_grafico0M4',
            type: 'bar'
        },
        title: {
		    margin:		    50,
	...
	/////////////////// grafico 2
	 chart2M4 = new Highcharts.Chart({
        chart: {
		    renderTo: 'container_grafico2M4',
            type: 'line'
        },
        title: {
		    margin:		    50,
	...
	// grafico 3
	 ...
	 chart3M4 = new Highcharts.Chart({
        chart: {
		    renderTo: 'container_grafico3M4',
			marginBottom: 300,
            type: 'line'
        },
        title: {
...
?>		
	...
	// grafico 4
	 ...
	 chart4M4 = new Highcharts.Chart({
        chart: {
		    renderTo: 'container_grafico4M4',
			// marginBottom: 300,
            type: 'bar'
        },
        title: {
...
*/
function AbreFechaM4(op)
{
    var id = "#container_grafico"+op+'M4';
    $(id).toggle();  
	return false;
}
