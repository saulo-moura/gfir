...
if ($opcao == 'inc') {
    ...
    if ($rs->rows == 0) {
        $msgErro = 'Você não esta cadastrado no sistema como AOE! Com isso não pode realizar a Segunda Visita.';
    } else if ($rs->rows > 1) {
        $msgErro = 'Você tem mais de um cadastro ativos de AOE no sistema! Só pode ter um cadastro ativo para realizar a Segunda Visita.';
    }
    ...
    if ($msgErro != '') {
        ...
        <script type="text/javascript">
            ...
            self.location = "<?php echo $_SESSION[CS]['grc_nan_visita_2_avulso']; ?>";
        </script>
        <?php
        exit();
    }
...
if ($temsenha == 9) {   // sem pessoa associada
    ...
    if ($temsenha == 1) {   // tem senha associada - chamar cadastro
        $veio = 255;
        $menu = 'grc_nan_visita_2_cadastro';
        $prefixo = 'cadastro';
...
<script type="text/javascript">
    ...
    {
        self.location = "<?php echo $_SESSION[CS]['grc_nan_visita_2_'.$session_volta]; ?>";
        return false;
    }
    ...
    function EscondeCadastro()
    {
        ...
        var href = "conteudo.php?prefixo=inc&menu=grc_nan_visita_2&idt_atendimento_agenda=" + idt_atendimento_agenda + "&idt_atendimento=" + idt_atendimento + "&id=" + idt_atendimento_agenda + "&aba=2";
        self.location = href;
    ...
    function EscondeAtendimento()
    {
        ...
        var href = "conteudo.php?prefixo=inc&menu=grc_nan_visita_2&idt_atendimento_agenda=" + idt_atendimento_agenda + "&idt_atendimento=" + idt_atendimento + "&id=" + idt_atendimento_agenda + "&aba=1";
        self.location = href;
        return false;
