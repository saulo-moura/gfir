...
$include = "cadastro_conf/grc_nan_protocolo_2visita.php";
...
$sql = "select ";
$sql .= "   grc_at.idt_grupo_atendimento, grc_nga.num_visita_atu, grc_nga.pdf_protocolo";
...
$nome_arquivo = $rowGA['idt_grupo_atendimento']."_pdf_protocolo_{$microtime}_protocolo2visita.pdf";
