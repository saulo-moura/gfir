...
$filhoCodListarCmbMulti = 'codigo_tratado';
$filhoSeparadorListarCmbMulti = '.';

function func_trata_row_sos(&$row) {
    global $filhoCodListarCmbMulti, $filhoSeparadorListarCmbMulti;

    $cod = explode($filhoSeparadorListarCmbMulti, $row['classificacao']);
    ...
    $row[$filhoCodListarCmbMulti] = implode($filhoSeparadorListarCmbMulti, $cod);
}

$func_trata_row = 'func_trata_row_sos';
...
$sql = 'select ';
$sql .= '   scaos.*,  ';
$sql .= '   scaos.classificacao as codigo_tratado,';
