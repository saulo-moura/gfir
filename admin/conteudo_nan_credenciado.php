...
if ($_REQUEST['pa'] == '')
	...
	$descricao_pa = $_REQUEST['pa'];
	

if ($_REQUEST['idt_ponto_atendimento'] == '')
    $idt_ponto_atendimento=0;
else
	$idt_ponto_atendimento = $_REQUEST['idt_ponto_atendimento'];
...
<table border="0" cellpadding="0" width="100%" cellspacing="0" class="Menu_printqsma">
    <tr>
		...
		//	echo "<div onclick='javascript:hidePopWin(true);' title='Retorna a Home ' style='cursor:pointer; padding-left:15px;'>";
			...
			echo "<div onclick='javascript:close();' title='Retorna' style='cursor:pointer; padding-left:15px;'>";
            ...
            echo "<center>";
            $titulo_modulo="NAN - EMPRESAS EXECUTORAS E AOEs";
 ...
 <div id="barra_topo_m">
										...
										echo '       <a href="javascript:close();" title="Clique aqui retornar"><img alt="" src="imagens/sair.png" width="32" height="32"></a>';
