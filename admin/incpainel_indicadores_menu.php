...
echo "<div id='oph' class='op' {$onclickA} {$hinth} >";
...
/*
Desativado por Esmeraldo em 28/08/2017 16:13 pois só pode gerar via job
...
//onclick=\"return imprimir('$menu');\";
$menu = 'Indicadores';
$onclickA = " onclick = 'return relatorio_exportar_xls(" . '"' . $menu . '"' . ");' ";
$hint8 = "title = 'Clique aqui para Gerar planilha dos Indicadores de Qualidade. Pode demorar...'";
echo "<div id='op8' class='op' {$onclickA} {$hint8} >";
echo "   <a  class='op_a' style=''>Exportar Indicadores</a> ";
echo "</div>";

//onclick=\"return imprimir('$menu');\";
$menu = 'DW Excel';
$onclickA = " onclick = 'return relatorio_exportar_dw_xls(" . '"' . $menu . '"' . ");' ";
$hint9 = "title = 'Clique aqui para baixar o DW. Pode demorar...'";
echo "<div id='op9' class='op' {$onclickA} {$hint9} >";
echo "   <a  class='op_a' style=''>Exportar DW</a> ";
echo "</div>";

$onclickA = " onclick = 'return opCadRFB();' ";
$hint9 = "title = 'Clique aqui para abrir o cadastro da RFB'";
echo "<div id='op9' class='op' {$onclickA} {$hint9} >";
echo "   <a  class='op_a' style=''>Cadastro da RFB</a> ";
echo "</div>";
...
$chamar = "incmatriz_indicadores_home";
$Require_Once = "{$chamar}.php";
if (file_exists($Require_Once)) {
    	Require_Once($Require_Once);
} else {
...
// var idt_organizacao = <?php echo $idt_organizacao; ?>;
    ...
    function relatorio_exportar_xls($bt_print_tit_rel) {
        var left = 10;
        var top = 10;
        var height = $(window).height() - 0;
        var width = $(window).width() - 20;
        var link = 'conteudo_indicadores_xls.php?prefixo=inc&menu=indicador_xls';
        IndicadorXLS = window.open(link, "linkIndicadorXLS", "left=" + left + ",top=" + top + ",width=" + width + ",height=" + height + ",location=no,resizable=yes,menubar=no,scrollbars=yes,toolbar=no,alwaysLowered=yes,alwaysRaised=no,dependent=yes,directories=no,hotkeys=no,menubar=no,personalbar=no,scrollbars=yes,status=no,titlebar=no,z-lock=yes,titlebar=no");
        IndicadorXLS.focus();
        return false;
    }
    function relatorio_exportar_dw_xls($bt_print_tit_rel) {
        var left = 10;
        var top = 10;
        var height = $(window).height() - 0;
        var width = $(window).width() - 20;
        var link = 'conteudo_indicadores_xls.php?prefixo=inc&menu=exporta_dw_xls';
        IndicadorXLS = window.open(link, "linkIndicadorXLS", "left=" + left + ",top=" + top + ",width=" + width + ",height=" + height + ",location=no,resizable=yes,menubar=no,scrollbars=yes,toolbar=no,alwaysLowered=yes,alwaysRaised=no,dependent=yes,directories=no,hotkeys=no,menubar=no,personalbar=no,scrollbars=yes,status=no,titlebar=no,z-lock=yes,titlebar=no");
        IndicadorXLS.focus();
        return false;
    }
...
//    }
    ...
    function opCadRFB()
    {
        var url = 'conteudo_indicador_qd_det.php?prefixo=listar&menu=bc_rf&veio_at=RFB';
        OpenWin(url, 'RFB', screen.width, screen.height, 0, 0);
    }
