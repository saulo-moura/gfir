...
$fonte = 'CRM|Sebrae Bahia';
$nome_gerador = $_SESSION[CS]['g_nome_completo']; 
...
$header .= '<img style="padding:5px;" src="relatorio/sebraetec_logo.png" alt="" border="0" />';
$header .= '</td>';

$header .= '<td align="center" style="font-size: 18px; color: #2a5696; padding:5px; margin-top:10px; border-bottom: 1px solid #ecf0f1;" colspan="2">';
$header .= $nome_titulo;
$header .= '</td>';
...
$footer .= 'Fonte: ' . $fonte . '<br/>';
$footer .= 'Data: ' . Date('d/m/Y H:i:s') . '<br/>';
$footer .= 'Gerado por: ' . $nome_gerador . '<br/>';
$footer .= '</td>';

$footer .= '<td align="right" width="200" style="font-size: 10px; padding-right:20px; border-bottom: 1px solid #ecf0f1;">';
$footer .= '<br />{PAGENO}';
$footer .= '</td>';
