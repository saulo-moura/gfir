...
//QuantitativosAtendimento($vetInstrumento,$vetPontoUR,$idt_dimensao, $condicao, $vetDimensao,$vetDimensaoTotal,$TotalGeral_G, $vetDimensaoInstrumento, $vetDimensaoTempoI, $vetDimensaoTempoP,1);
...
$condicao    = " (grc_ev.idt_evento_situacao = 14 or grc_ev.idt_evento_situacao = 16 or grc_ev.idt_evento_situacao = 19 or grc_ev.idt_evento_situacao = 20 )";

//$condicao    .= " and grc_ev.dt_previsao_inicial >= ".aspa(trata_data('29/08/2016'));
//$condicao    .= " and grc_ev.dt_previsao_inicial <= ".aspa(trata_data('03/09/2016'));
