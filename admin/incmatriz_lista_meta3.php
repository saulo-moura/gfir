...
function CriarDimensoesAtendimentoMeta3(&$vetDimensao) {
    $kokw = 0;
	$vetPontoUR = Array();
...
function QuantitativosAtendimentoMeta3($vetInstrumento,$vetPontoUR,$idt_dimensao, $condicao, &$vetDimensao, &$vetDimensaoTotal, &$TotalGeral_G, &$vetDimensaoInstrumento, &$vetDimensaoTempoI, &$vetDimensaoTempoP,$op,&$vetMensal,&$vetEst) {
    //$vetDimensao = Array();
	...
	$condicao .= " and meta3 = 'S' and ordem_cnpj = 1  ";
...
$condicao       = ""; // todos os produtos
QuantitativosAtendimentoMeta3($vetInstrumento,$vetPontoUR,$idt_dimensao, $condicao, $vetDimensao,$vetDimensaoTotal,$TotalGeral_G, $vetDimensaoInstrumento, $vetDimensaoTempoI, $vetDimensaoTempoP,1,$vetMensal,$vetEst);
...
$condicao       = ""; // todos os produtos
QuantitativosAtendimentoMeta3($vetInstrumento,$vetPontoUR,$idt_dimensao, $condicao, $vetDimensao,$vetDimensaoTotal,$TotalGeral_G, $vetDimensaoInstrumento, $vetDimensaoTempoI, $vetDimensaoTempoP,2,$vetMensal,$vetEst);
...
echo "<div id='meta3_titulo' class='cb_titulo_meta'>";
echo "Meta 3 - Atendimentos a Pequenos Negócios - MEI ";
echo "</div>";
...
$metaanual = $vetMetasValorAnual['MM3'];
...
$onclick = " onclick='return AbreFechaM3(0);'; ";
$title = " title='Clique aqui para exibir ou esconder o Gráfico' ";
echo  "<div id='grafico0M3' {$onclick} style=''>";
echo  "<div id='grafico0tM3' {$title} style='padding-left:5px; border-bottom:1px solid #FFFFFF; cursor:pointer; float:left; width:100%; height:30px; background:#2A5696; color:#FFFFFF;'>";
echo  "1 - Público Sebrae";
echo  "</div>";
echo  "<div id='container_grafico0M3' style='display:none; float:left; width:100%; height:{$altura}px; margin-top:10px; border-top:3px solid #2A5696;'></div>";
echo "</div>";
...
$onclick = " onclick='return AbreFechaM3(1);'; ";
$title = " title='Clique aqui para exibir ou esconder o Gráfico' ";
echo  "<div id='grafico1M3' {$onclick} style=''>";
echo  "<div id='grafico1tM3' {$title} style='padding-left:5px; border-bottom:1px solid #FFFFFF; cursor:pointer; float:left; width:100%; height:30px; background:#2A5696; color:#FFFFFF;'>";
echo  "2 - Atendimentos - Curva ABC";
echo  "</div>";
echo  "<div id='container_grafico1M3' style='display:none; float:left; width:100%; height:{$altura}px; margin-top:10px; border-top:3px solid #2A5696;'></div>";
echo "</div>";
...
$onclick = " onclick='return AbreFechaM3(3);'; ";
echo  "<div id='grafico3M3' {$onclick} style=''>";
echo  "<div id='grafico3tM3' {$title} style='padding-left:5px; border-bottom:1px solid #FFFFFF; cursor:pointer; float:left; width:100%; height:30px; background:#2A5696; color:#FFFFFF;'>";
echo  "3 - Unidades Regionais - Atendimento por Instrumento";
echo  "</div>";
echo  "<div id='container_grafico3M3' style='display:none; float:left; width:100%; height:{$altura}px; margin-top:10px; border-top:3px solid #2A5696; border-bottom:3px solid #2A5696;'></div>";
echo "</div>";


$onclick = " onclick='return AbreFechaM3(2);'; ";
echo  "<div id='grafico2M3' {$onclick} style=''>";
echo  "<div id='grafico2tM3' {$title} style='padding-left:5px; border-bottom:1px solid #FFFFFF; cursor:pointer; float:left; width:100%; height:30px; background:#2A5696; color:#FFFFFF;'>";
echo  "4 - Atendimentos Mensal - Quantidade";
echo  "</div>";
echo  "<div id='container_grafico2M3' style='display:none; float:left; width:100%; height:{$altura}px; margin-top:10px; border-top:3px solid #2A5696; border-bottom:3px solid #2A5696;'></div>";
echo  "</div>";



$onclick = " onclick='return AbreFechaM3(4);'; ";
echo  "<div id='grafico4M3' {$onclick} style=''>";
echo  "<div id='grafico4tM3' {$title} style='padding-left:5px; border-bottom:1px solid #FFFFFF; cursor:pointer; float:left; width:100%; height:30px; background:#2A5696; color:#FFFFFF;'>";
echo  "5 - Atendimentos por Instrumento - Geral";
echo  "</div>";
echo  "<div id='container_grafico4M3' style='display:none; float:left; width:100%; height:{$altura}px; margin-top:10px; border-top:3px solid #2A5696; border-bottom:3px solid #2A5696;'></div>";
echo  "</div>";
...
$(document).ready(function() {
    ...
    chartM3 = new Highcharts.Chart({
        chart: {
		    renderTo: 'container_grafico0M3',
            type: 'bar'
        },
        title: {
		    margin:		    50,
	...
	/////////////////// grafico 2
	 chart2M3 = new Highcharts.Chart({
        chart: {
		    renderTo: 'container_grafico2M3',
            type: 'line'
        },
        title: {
		    margin:		    50,
	...
	// grafico 3
	 ...
	 chart3M3 = new Highcharts.Chart({
        chart: {
		    renderTo: 'container_grafico3M3',
			marginBottom: 300,
            type: 'line'
        },
        title: {
...
?>		
	...
	// grafico 4
	 ...
	 chart4M3 = new Highcharts.Chart({
        chart: {
		    renderTo: 'container_grafico4M3',
			// marginBottom: 300,
            type: 'bar'
        },
        title: {
...
*/
function AbreFechaM3(op)
{
    var id = "#container_grafico"+op+'M3';
    $(id).toggle();  
	return false;
}
