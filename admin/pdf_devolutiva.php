...
define('geraPDF', true);
$include = "cadastro_conf/grc_nan_devolutiva_rel_inc.php";
...
$htmlO = "<div id='container_grafico1'></div>";
$htmlD = "<div id='container_grafico1'><img src='".$exportPath.'_grafico1.png'."' /></div>";
$html = str_replace($htmlO, $htmlD, $html);

$htmlO = "<div id='container_grafico2'></div>";
$htmlD = "<div id='container_grafico2'><img src='".$exportPath.'_grafico2.png'."' /></div>";
$html = str_replace($htmlO, $htmlD, $html);

$htmlO = "<div id='container_graficoc1'></div>";
$htmlD = "<div id='container_graficoc1'><img src='".$exportPath.'_graficoc1.png'."' /></div>";
$html = str_replace($htmlO, $htmlD, $html);

$htmlO = "<div id='container_graficoc2'></div>";
$htmlD = "<div id='container_graficoc2'><img src='".$exportPath.'_graficoc2.png'."' /></div>";
$html = str_replace($htmlO, $htmlD, $html);
...
$sql = "select ";
$sql .= "   grc_at.idt_grupo_atendimento, grc_nga.num_visita_atu, grc_nga.pdf_devolutiva";
...
$nome_arquivo = $rowGA['idt_grupo_atendimento']."_pdf_devolutiva_{$microtime}_devolutiva.pdf";
