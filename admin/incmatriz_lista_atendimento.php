...
function QuantitativosAtendimento($vetInstrumento,$vetPontoUR,$idt_dimensao, $condicao, &$vetDimensao, &$vetDimensaoTotal, &$TotalGeral_G, &$vetDimensaoInstrumento, &$vetDimensaoTempoI, &$vetDimensaoTempoP) {
	...
	//$condicao    = " data < '2016-07-01' and (situacao = 'Finalizado' or situacao = 'Finalizado em Alteração') and idt_evento is null and idt_grupo_atendimento is null ";
	
	$condicao    = " year(grc_a.data)= 2016 and (grc_a.situacao = 'Finalizado' or grc_a.situacao = 'Finalizado em Alteração') and grc_a.idt_evento is null and grc_a.idt_grupo_atendimento is null ";
