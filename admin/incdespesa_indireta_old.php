...
echo "   <td class='despesa_direta_cab_td' >&nbsp;"."Quantidade"."</td> ";
echo "   <td class='despesa_direta_cab_td' >&nbsp;"."Preço Unitário<br>(R$)"."</td> ";
echo "   <td class='despesa_direta_cab_td' >&nbsp;"."Preço Total<br>(R$)"."</td> ";
echo "</tr>";
...
ForEach($rs->data as $row) {
   ...
   $oo_quantidade      = $row['oo_quantidade'];
   $oo_valor_unitario  = $row['oo_valor_unitario'];
   $oo_valor_total     = $row['oo_valor_total'];
   ...
   echo "   <td class='{$classe}' >&nbsp;".$oo_quantidade."</td> ";
   echo "   <td class='{$classe}' >&nbsp;".$oo_valor_unitario."</td> ";
   echo "   <td class='{$classe}' >&nbsp;".$oo_valor_total."</td> ";
   echo "</tr>";
}
echo "</table>";
