...
class TGSW_CALENDARIO
{
	...
	public function MostraCalendario($vetHtml)
    {
		...
		*/
		...
		$html .= "<section style='width:100%; xheight:30em; float:left;'>";
		
		
		
		
	    $html .= "<div id='filtro' class='col-lg-3' style='width:65%; float:left;'>";
		$html .= "<div style='width:100%; text-align:center;  line-height:1.0em; font-weight: bold;'>";
		$html .= "Filtros de Pesquisa";
		$html .= "</div>";
		...
		$html .= "<div id='calendario' style='margin-right:10px; float:right; width:33%; '></div>";
		...
		$html .= "<div id='calendario_instrucao' style='xborder:1px solid blue; width:65%; float:left; xpadding-left:1em; xborder:1px solid red; '>";
		$html .= "<div style='width:100%; xborder:1px solid blue; margin-left:3.5em;'>";
		...
		$html .= "<div style='width:100%; list-style-type:none;   '>";
		
		$html .= "<div style='width:60%; line-height:1.0em; font-weight: bold; text-align:center; '>";
		$html .= "Legenda";
		$html .= "</div>";
		$html .= "<div style='width:39%; line-height:1.0em; font-weight: bold; text-align:center; '>";
		$html .= "&nbsp";
		$html .= "</div>";
		
		$html .= "<div style='float:left; width:30%; color:#666666; line-height:0.5em;'>";
		
		$html .= "<img width='16' height='16' src='{$imagem1}' style='padding-top:0.5em; xpadding-right:0.5em;' />";
		$html .= "&nbsp;&nbsp;Incluir Cliente";
		$html .= "</div>";
		
		$html .= "<div style='float:left; width:69%; color:#666666; line-height:0.5em;'>";
		$html .= "<img width='16' height='16' src='{$imagem2}' style='padding-top:0.5em; xpadding-right:0.5em;' />";
		$html .= "&nbsp;&nbsp;Visualizar Cadastro";
		$html .= "</div>";
		...
		$html .= "<div style='float:left; width:30%; color:#666666; line-height:0.5em;'>";
		$html .= "<img width='16' height='16' src='{$imagem4}' style='padding-top:0.5em; xpadding-right:0.5em;' />";
		$html .= "&nbsp;&nbsp;Remover Cliente";
		$html .= "</div>";

		$html .= "<div style='float:left; width:69%; color:#666666; line-height:0.5em;'>";
		$html .= "<img width='16' height='16' src='{$imagem5}' style='padding-top:0.5em; xpadding-right:0.5em;' />";
		$html .= "&nbsp;&nbsp;Histórico de Agendamento";
		$html .= "</div>";

		$html .= "<div style='float:left; width:30%; color:#666666; line-height:0.5em;'>";
		$html .= "<img width='16' height='16' src='{$imagem6}' style='padding-top:0.5em; xpadding-right:0.5em;' />";
		$html .= "&nbsp;&nbsp;Visualizar Agendamento";
		$html .= "</div>";

		$html .= "<div style='float:left; width:69%; color:#666666; xborder:1px solid red;  line-height:0.5em;'>";
		$html .= "<img width='16' height='16' src='{$imagem7}' style='padding-top:0.5em; xpadding-right:0.5em;' />";
		$html .= "&nbsp;&nbsp;Excluir Cliente";
		$html .= "</div>";
		...
		$html .= "<div style='width:100%; text-align:center; line-height:1.0em; font-weight: bold;'>";
		$html .= "Data Selecionada";
		$html .= "</div>";
		
		$html .= "<div id='calendario_destaque' style='margin:0; margin-right:10px; xborder:1px solid red; background: #F1F1F1; float:right; width:33%; '></div>";
		...
		*/
		...
		$html .= "<div id='horario_geral' class='col-lg-6' style='float:left; width:100%; xborder:1px solid #FFFFFF; xborder-top:1px solid #FFFFFF; xborder-right:1px solid #FFFFFF; '>";
...
$html .= "            else ";
$html .= "            { ";
$html .= "                return [1,'naodisponivel','Todos os Horários Não Disponíveis para Agendamento...']; ";
$html .= "            } ";
$html .= "        }  ";
$html .= "        else ";
$html .= "        { ";
...
//        $html .= "        var data_atual = new Date(datew, 'dd.mm.yyyy'); ";
	...
	*/	
    ...
    $html .= " var parww='&idt_atendimento_agenda='+idt_atendimento_agenda+'&idt_ponto_atendimento='+idt_ponto_atendimento+'&deondeveio=Distancia'+'&veio_at='+veio_at+'&idt_atendimento='+idt_atendimento; ";
...
$html .= " var parww='&idt_atendimento_agenda='+idt_atendimento_agenda+'&idt_ponto_atendimento='+idt_ponto_atendimento+'&deondeveio=Distancia&acaoc=con'; ";
	...
	$html .= " function MostraServicos(idt_agenda) ";
	$html .= " { ";
	$html .= "     var id='#ser_oc'+idt_agenda; ";	
	$html .= "     $(id).toggle(); ";	
	$html .= " } ";	
	...
	echo "<div style=' xborder-bottom:2px solid #FFFFFF; font-size:1.3em; color:#2F65BB; padding-left:20px; display:block; text-align:center;'>";
