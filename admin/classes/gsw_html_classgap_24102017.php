...
//			function criar_combo_rs($rs, $NomeCombo, $PreSelect, $LinhaFixa, $JS, $style = '', $lang = '', $return = False, $id = '', $msg_sem_registro = 'Não existe informação no sistema') {
	...
	public function BotaoSelecao($vetPar)
    {
		...
		$html .= " self.location = 'conteudo_calendario.php?veio='+veio+'&veio_at='+veio_at+'&agenda_data='+agenda_data+'&idt_servico='+idt_servico+'&idt_unidade_regional='+idt_unidade_regional+'&idt_ponto_atendimento='+idt_ponto_atendimento+'&idt_consultor='+idt_consultor+'&idt_atendimento='+idt_atendimento; ";
