...
Require_Once('admin/definicao_class.php');
...
$nome_site = 'PIR.GRC::Clientes'; // Nome do sistema
$sigla_site = 'GRC_GC'; // Sigla do sistema
//
define('CS', 'site_'.$sigla_site.'_'.md5($host));
define('reg_pagina', 50);

$plu_sigla_interna = 'GEC';
$plu_codigo_interna = 'GC';

Require_Once('admin/definicao_lib.php');

define('ajax_plu', 'admin/ajax_plu.php?o=s');
