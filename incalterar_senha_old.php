...
switch ($_POST['btnAcao']) {
	case 'Confirmar':
         ...
         if ($result->rows == 0) {
         ...
         } else { if ($_POST['senha_nova'] != $_POST['senha_nova_repete']) {
		    ...
		    $msg .= "Estamos comunicando que a sua solicitação de modificação da senha no site PCO foi aceita.<br>";
		    ...
		    $msg .= "Administrador do Site <b>oas</b> PCO.";
            ...
            if ($erro=='0')
            {  // comunicação de tentativa de modificação enviada
               // modificar
               ...
               if ($result->rows == 0) {
    		      ...
    		      $msg  = "Sr(a) ".$_POST['nome']."<br>";
            	  $msg .= "E-Mail: ".$_POST['email']."<br>";
		          $msg .= "Estamos comunicando que a sua <b>SENHA</b> no site PCO foi MODIFICADA COM SUCESSO....<br>";
...
if ($erro!='0')
{
    ...
    echo '<a>Essa Função possibilita a alteração da sua senha no site PCO.<br>Por segurança, informe novamente a sua senha atual, digite a senha desejada e redigite a senha desejada.<br> Lembre que o Site é sensivel a letras maiúsculas/minusculas. </a>';
    echo "</div>";
}
if ($_SESSION[CS]['g_senha_antiga'] == md5($vetConf['senha_padrao']))
{
    echo "<div id='senha_padrao' >";
    echo '<a>ATENÇÃO...<br><br>Sua senha é a Padrão do site PCO.<br><br> Altere imediatamente a sua senha.<br></a>';
    echo "</div>";
}
...
$senha_atualw="<input class='Texto' type='password' name='senha_atual' value='{$senha_atual}' maxlength='45' size='45' onblur='return true;' onkeyup='return return true;' )'><br>";
...
$senha_novaw="<input class='Texto' type='password' name='senha_nova' value='{$senha_nova}' maxlength='45' size='45' onblur='return true;' onkeyup='return return true;' )'><br>";
...
$senha_nova_repetew="<input class='Texto' type='password' name='senha_nova_repete' value='{$senha_nova_repete}' maxlength='45' size='45' onblur='return true;' onkeyup='return return true;' )'><br>";
