...
try {
  ...
  //  echo " vou fazer<br /> ";
    ...
    $info = $PF_SAP->executa('ConsultaSubareaSGC', 'ZSUBAREASGC', $parametro);
    //  p($info);
    // echo 'Fim';
    ForEach ($info->data as $row) {
       $nome          = $row['NOME'];
       ...
       $idt_area      = $row['IDAREA'];
       $idt_subarea   = $row['ID'];
       echo " $nome - $ativa - $idt_area - $idt_subarea <br />";
    }
    // SubArea
    echo " ESPECIALIDADE <br />";
    $parametro = Array(
    );
    $info = $PF_SAP->executa('ConsultaEspecialidadeSGC', 'ZESPECIALIDADESGC', $parametro);
    //  p($info);
    // echo 'Fim';
    ForEach ($info->data as $row) {
       $nome              = $row['NOME'];
       ...
       echo " $nome - $ativa - $idt_area - $idt_subarea - $idt_especialidade <br />";
    }
